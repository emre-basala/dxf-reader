...
module DXF
  class Unparser
    ...
    def line(first, last, layer=0, transformation=nil, color_code: 0)
...
# @group Property Converters
    ...
    def to_array(element, transformation=nil)
        ...
        when Geometry::Edge, Geometry::Line
          color_code = element.respond_to?(:color_code) ? element.color_code : nil
          line(element.first, element.last, layer, transformation, color_code: color_code)
